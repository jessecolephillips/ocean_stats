...
Install and load the necessary packages; `rerddap` to access ERDDAP servers with R, `dplyr` to manipulate the incoming data and `ggplot2` to to create visuals. The `stringr` package is used to clean up received data later.
